...
UBUNTU_TRANSLATION_DOMAIN="organizer.liu-xiao-guo"
...
aptest.commands = bash $$PWD/organizer/tests/autopilot/run
aptest.depends  = sub-organizer

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/organizer/tests/unit 
unittest.depends  = sub-organizer
